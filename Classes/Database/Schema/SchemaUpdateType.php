...
class SchemaUpdateType extends Enumeration
{
     ...
     * Add a field
     */
    public const FIELD_ADD = 'field.add';

    /**
     * Change a field
     */
    public const FIELD_CHANGE = 'field.change';

    /**
     * Prefix a field
     */
    public const FIELD_PREFIX = 'field.prefix';

    /**
     * Drop a field
     */
    public const FIELD_DROP = 'field.drop';

    /**
     * Add a table
     */
    public const TABLE_ADD = 'table.add';

    /**
     * Change a table
     */
    public const TABLE_CHANGE = 'table.change';
     ...
     * Drop a table
     */
    public const TABLE_DROP = 'table.drop';

    /**
     * All safe update types
     */
    public const GROUP_SAFE = 'safe';

    /**
     * All destructive update types
     */
    public const GROUP_DESTRUCTIVE = 'destructive';
