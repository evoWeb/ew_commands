...
class MysqlCommand
{
    ...
    public function __construct(array $dbConfig, array $commandLine = [], OutputInterface $output = null)
    {
        $this->dbConfig = $dbConfig;
        // @deprecated commandline will be removed in 6.0
        $this->commandLine = $commandLine;
        // output being optional is @deprecated. Will become required in 6.0
